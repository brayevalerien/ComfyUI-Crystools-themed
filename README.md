> [!CAUTION]
> To make the monitor work properly, please close this repo in your `ComfyUI/custom_nodes/` directory using the following command.
> ```bash
> git clone https://github.com/brayevalerien/ComfyUI-Crystools-themed ComfyUI-Crystools
> ```
> Make sure to follow the casing strictly.
